  ...
  return (
    <div id="boxServices">
      ...
      <div className="categoryButtons">
        ...
        <button onClick={() => setCategory("autos")} className="buttonServices">
          Autos/Camionetas
        </button>
      </div>
          ...
          <div className="boxMotos">
            ...
            <div className="service">
              ...
              <ul>
                ...
                <li>
                  Aplicación de cera rápida para dar brillo, semi protección a
                  la pintura y semi repelencia al agua.
                </li>
              </ul>
            ...
            <div className="service">
              ...
              <ul>
                <li>Limpieza y lubricación completa del Kit de Arrastre,</li>
                <li>
                  Pre-lavado para eliminar toda suciedad / contaminante
                  superficial.
                </li>
                <li>
                ...
                <li>Rejuvenecimiento de plásticos, gomas.</li>
                <li>
                  Aplicación de cera en pasta para dar mucho brillo, protección
                  a la pintura y repelencia al agua (Duración 6 a 8 meses).
                </li>
              </ul>
